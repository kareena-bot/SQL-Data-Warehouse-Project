...
Script Purpose:
    ...
    - Uses the `INSERT INTO` command to load data from the bronze layer tables to silvertables.
...
DECLARE @start_time DATETIME, @end_time DATETIME, @batch_start_time DATETIME, @batch_end_time DATETIME;
	BEGIN TRY
		...
		(
		SELECT *,
			ROW_NUMBER() OVER(PARTITION BY cst_id ORDER BY cst_create_date DESC) flag_1
